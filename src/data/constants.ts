...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      "Maintained large-scale open-source CMS (Python). Improved API security and data pipelines.",
      "Adhered to Agile/Scrum rituals, utilizing Jira and Bitbucket for version control and team communication.",
      "Led codebase refactoring to MVVM, ensured best practices in documentation.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.REACT,
  ...
  },
  {
    ...
    company: "Hexbit",
    description: [
      "Built and optimized REST APIs using Node.js, Python, React – scaled to 500+ users.",
      "Engaged in Agile development cycles, collaborating via Bitbucket, Git, and Jira.",
      "Refactored backend modules, adopted MVC and MVP methodologies for clarity and testability.",
      "Designed mobile app features (React Native, iOS integration), enabling seamless data flow through secure APIs.",
    ],
    skills: [
      SkillNames.NODEJS,
      SkillNames.REACT,
