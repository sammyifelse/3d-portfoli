...
const projects: Project[] = [
  ...
  },
  {
    ...
    src: "/assets/projects-screenshots/fraudguard/landing.png",
    screenshots: ["landing.png"],
    live: "https://github.com/yourusername/fraudguard",
    github: "https://github.com/sammyifelse/hackth",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono ">
            Advanced AI-powered fraud detection platform for real-time analysis of 250K+ transactions with 99.8%+ accuracy.
          ...
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc list-inside font-mono mb-2 space-y-2">
            <li>Google Gemini Integration: Natural language fraud explanations</li>
            <li>Multiple Formats: Credit Card, UPI, Bank Transfers, E-commerce</li>
            <li>Production Deployment: Docker & cloud-ready</li>
          </ul>
        </div>
      );
    },
    ...
    get content() {
      return (
        <div>
          ...
          <TypographyH3 className="my-4 mt-8">Key Features</TypographyH3>
          <ul className="list-disc list-inside font-mono mb-2 space-y-2">
            <li>Multi-format Resume Parsing: Support for PDF, DOCX, and TXT files</li>
            <li>Advanced NLP Processing: Powered by spaCy for intelligent text analysis</li>
            <li>Contact Information Extraction: Automated extraction of names, emails, phone numbers, and LinkedIn profiles</li>
          </ul>
        </div>
      );
    },
